    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.datagurus.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nip') ? 'is-invalid' : '' }}" type="number" name="nip" id="nip" value="{{ old('nip', '') }}">
                @if($errors->has('nip'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nip') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mapel') ? 'is-invalid' : '' }}" type="text" name="mapel" id="mapel" value="{{ old('mapel', '') }}" step="0.01">
                @if($errors->has('mapel'))
                    <div class="invalid-feedback">
                        {{ $errors->first('mapel') }}
                    </div>
